// Single source of truth for the additional Cybersecurity Roles modules (weeks 9-13).
// Used by apply-modules-roles.mjs to (a) apply them to Supabase and (b) generate
// supabase/insert-modules-roles.sql for re-running later.

export const roleModules = [
  {
    week_no: 9,
    title: "Cybersecurity Roles, Specializations & Career Paths",
    description:
      "A field map of cybersecurity careers: what each role does, the skills it needs, and where the first eight weeks fit.",
    content: `# Week 9 — Cybersecurity Roles, Specializations & Career Paths
...
Pick **two roles** that interest you. For each, write down: the three main tasks, the two tools it relies on, which of your first eight weeks it leans on most, and one cert a rookie in that role would study first. This exercise becomes your career map.`,
  },
  {
    week_no: 10,
    title: "Blue Team Ops — Inside a SOC",
    description:
      "How a Security Operations Center really runs: monitoring, alert triage, playbooks, escalation, and the day-to-day rhythm of a SOC analyst.",
    content: `# Week 10 — Blue Team Ops: Inside a SOC
...
Map a **mini pentest plan** for a fictional target: pick a lab or any authorized environment, then write the scope sentence, list three tools you would use for recon, one likely weakness you would look for, and how you would word the finding in your report. Getting the framing right is half the skill.`,
  },
  {
    week_no: 12,
    title: "Purple Team, DevSecOps & Security Engineering",
    description:
      "Where the two sides meet: embedding security into software delivery, threat modeling, and the engineering roles scaling security.",
    content: `# Week 12 — Purple Team, DevSecOps & Security Engineering
...
Pick one small system you use at school or at home (an app, a lab, a website). Run it through the four threat modeling questions above and list two controls you would add. You have just done the exact exercise a security engineer brings to every design review.`,
  },
  {
    week_no: 13,
    title: "GRC, Audits & Cyber Leadership",
    description:
      "Governance, risk and compliance — the roles that keep security organized: frameworks, risk registers, audits, and the path to leadership.",
    content: `# Week 13 — GRC, Audits & Cyber Leadership
